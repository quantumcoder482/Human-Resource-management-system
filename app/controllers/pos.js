...
function($rootScope, $scope, $http, $mdToast, $cookies, $mdDialog, $route, services){
  if($cookies.session_uid == 'null' || $cookies.session_uid == null){ $scope.Expire_Session(); }
    ...
    original = { items : [], quantity:[], prices:[],item_names:[],cgst:[],sgst:[],user_id:0 ,contact_name:null,contact_number:null,contact_address:null,bill_amount:0,payable_amount:0,customer_amount:null,order_cgst:0,order_sgst:0,order_comment:null,discount:0,type:1, gst_price:[], totalpaid:1, dispute:0};
